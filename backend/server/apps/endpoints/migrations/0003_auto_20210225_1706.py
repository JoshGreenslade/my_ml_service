# Generated by Django 3.1.7 on 2021-02-25 17:06
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('endpoints', '0002_auto_20210222_2032'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='status',
            field=models.CharField(choices=[('testing', 'testing'), ('staging', 'staging'), ('production', 'production'), ('ab_testing', 'ab_testing')], max_length=128),
        ),
